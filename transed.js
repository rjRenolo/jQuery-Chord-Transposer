...
function transpose(options) {
    ...
    var preEl = document.getElementsByTagName("pre")[0];
    // if (opts[0]) {
    //     console.log("something");
    //     transposeSong(preEl, opts[0]);
    //     // Array.from(
    ...
    transposeSong = function(target, key) {
        console.log(opts);
        ...
        var whatToChange = document.querySelectorAll(`span.c`);
    ...
    var transposeChord = function(selector, delta, targetKey) {
        var oldChord = selector.innerText;
    ...
    var startKey = preEl.getAttribute("data-key");
    var eachPre = document.getElementsByTagName("pre");

    Array.from(eachPre).forEach(thisLyrics);

    function thisLyrics(el, i) {
        // console.log("hatdoh", el.innerText);
